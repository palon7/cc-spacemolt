...
- **Game connection pause/resume**: Disconnect the game WS when frontend client count drops to 0; reconnect on first client. Avoids putting unnecessary load on SpaceMolt.
